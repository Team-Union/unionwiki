    ...
    if flask.request.method == 'POST':
        ...
        if platform.system() == 'Linux':
            ...
            urllib.request.urlretrieve(
                'https://github.com/TeamEND/endwiki/archive/' + up_data + '.zip', 'update.zip')
            zipfile.ZipFile('update.zip').extractall('')
            ok = os.system('xcopy /y /s /r endwiki-' + up_data + ' .')
            if ok == 0:
                os.system('rd /s /q endwiki-' + up_data)
        ...
        return easy_minify(flask.render_template(skin_check(),
            ...
            data = load_lang('update_warring') + '''
                ...
                <a href="https://github.com/TeamEND/endwiki">(Beta)</a> <a href="https://github.com/TeamEND/endwiki/tree/stable">(Stable)</a>
                <hr class=\"main_hr\">
                <form method="post">
